# Single LSTM with softmax activation
...
history_callback = model.fit(x, y,
                             ...
                             callbacks=[print_callback,
                                        ModelCheckpoint(
                                            f'save/char_' + f'{epochs}' + 'lstm_beherenow_128.h5py')])
...
# Export results
results.to_csv(f'results/char_{epoch_num}_lstm_beherenow_1step_128_{str(datetime.now())}.csv', index=False)